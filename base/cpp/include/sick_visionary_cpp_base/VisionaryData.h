...
public:
  ...
  std::pair<uint64_t, uint64_t> getTimestampMS() const;
...
private:
  ...
  static constexpr std::uint64_t BITMASK_TIMEZONE = 
      0x3FF8000000ull; // 0000000000000000000000000011111111111000000000000000000000000000
